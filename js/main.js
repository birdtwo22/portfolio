...
(function () {
  ...
  if (sessionStorage.getItem('sp-visited')) {
    ...
    SCATTER.forEach((idx, i) => {
      setTimeout(() => {
        splashCards[idx].style.transition = 'opacity 0.5s cubic-bezier(0.0,0.0,0.2,1), transform 0.6s cubic-bezier(0.22,1,0.36,1), background-color 0.6s ease';
    ...
    setTimeout(() => {
      ...
      const T = 'transform 0.85s cubic-bezier(0.4,0,1,1), background-color 0.6s ease';
